 ...
 */
Parser.prototype.oneOrMoreSeparatedBy = function <T, U, S>(
  this: Parser<T, S>,
  separator: Parser<U, S>
): Parser<T[], S> {
  return this.bind((x) =>
    separator
      .seq(this)
 ...
 */
Parser.prototype.zeroOrMoreSeparatedBy = function <T, U, S>(
  this: Parser<T, S>,
  separator: Parser<U, S>
): Parser<T[], S> {
 ...
 */
Parser.prototype.followedBy = function <T, U, S>(
  this: Parser<T, S>,
  after: Parser<U, S>
): Parser<T, S> {
 ...
 */
Parser.prototype.surroundedBy = function <T, U, S>(
  this: Parser<T, S>,
  surround: Parser<U, S>
): Parser<T, S> {
 ...
 * is returned.
 */
Parser.prototype.bracketedBy = function <T, U, V, S>(
  this: Parser<T, S>,
  open: Parser<U, S>,
  close: Parser<V, S>
): Parser<T, S> {
 ...
 * expression grammars.
 */
Parser.prototype.chainOneOrMore = function <T, S>(
  this: Parser<T, S>,
  operation: Parser<BinaryOp<T>, S>
): Parser<T, S> {
  return this.bind((x) =>
    operation
      .bind((f) => this.bind((y) => mret([f, y] as [BinaryOp<T>, T])))
      .zeroOrMore()
 ...
 */
Parser.prototype.chainZeroOrMore = function <T, S>(
  this: Parser<T, S>,
  operation: Parser<BinaryOp<T>, S>,
  value: T
): Parser<T, S> {
